...
import PFP from '../assets/images/man.png'
  ...
  return (
    <div className="container mt-16 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
        <div className="flex flex-wrap md:flex-nowrap">
            ...
            <div className="flex flex-wrap lg:ml-0 justify-center md:justify-start max-w-xl mt-0 md:my-36">
                ...
                <div className="w-full flex justify-center md:justify-start">
                    <button className="px-8 py-4 bg-theme text-gray-100 font-bold mt-12 flex items-center space-x-3">
                        <div>
            ...
            <img src={PFP} alt="profile" className="w-full md:w-2/4 bg-contain mt-12 md:absolute md:my-10 md:mx-auto right-0 md:right-10 -z-1" />
        </div>
    </div>
  )
}
